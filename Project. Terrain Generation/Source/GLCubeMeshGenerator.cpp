...
GLMesh GLCubeMeshGenerator::generate(const QColor& color)
{
...
void GLCubeMeshGenerator::init_indices(std::vector<unsigned>& indices)
{
}

void GLCubeMeshGenerator::init_vertices(std::vector<GLVertex>& vertices, const QColor& color)
{
}
