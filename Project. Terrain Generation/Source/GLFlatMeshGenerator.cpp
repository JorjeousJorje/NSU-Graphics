...
GLMesh GLFlatMeshGenerator::generate(const QColor& color)
{
    GLMesh mesh{};
...
void GLFlatMeshGenerator::init_vertices(std::vector<GLVertex>& vertices, const QColor& color)
{
...
void GLFlatMeshGenerator::init_indices(std::vector<unsigned>& indices)
{
