...
void GLMeshRenderer::render_wireframe(QOpenGLFunctions_3_0& functions, const Camera& camera)
{
...
void GLMeshRenderer::upload_camera_details(const Camera& camera) const
{
...
void GLMeshRenderer::enable_attributes() const 
{
	...
	shader_program_->enableAttributeArray("meanNormalAttr");
	shader_program_->setAttributeBuffer("meanNormalAttr", GL_FLOAT, offsetof(GLVertex, mean_normal), 3, sizeof(GLVertex));
}
